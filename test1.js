...
const ts = transaction.time;  // 时间戳
const fork = transaction.fork; // 分支
const nonce = transaction.nonce; // nonce值
const from = transaction.from;   // 地址from
const to = transaction.to;       // 地址to
const amount = transaction.amount;    // 金额
const gasPrice = transaction.gasprice;    // 价格
const gasLimit = transaction.gaslimit;    // gas的上限
